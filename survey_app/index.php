    ...
    <div class="container">
        ...
        <div class="panel panel-default" >
          <div class="panel-body" style="background-color:#e6e6e6;">
            <div class="col-lg-12">
                <img class="img-responsive" src="./images/gambar.jpg" alt="" style="height:300px;width:1290px">
                <hr>
            </div>
            <div class="col-lg-12">
                                   ...
                                   <div class="form-group">
                                       ...
                                       <div class="col-sm-3">
                                           <div class="input-group">
                                               ...
                                               <select name="companyProduct" id="kategori" class="form-control">
                       ...
                       <tr>
                          <td width="97%" valign="top" align="center" colspan="5" style="border-style: none; border-width: medium">
                              <font face="Arial" size="1"><b>Mohon kesediaan Anda untuk memberikan 
                                  penilaian dan masukan kepada PT. Mitra Gemilang Inti Perkasa Pekalongan, dimana hal ini sangat bermanfaat 
                              ...
                              <thead>
                                  ...
                                  <th colspan='2'><p align='center'><b><font face='Tahoma' size='2'>DESKRIPSI</font></b></th>
                                      ...
                                      <tbody>
                                          ...
                                          error_reporting(0);
                                          $no = 1;
                                          $sql = mysqli_query($masuk,"SELECT * FROM tgroup");
                                          while($data = mysqli_fetch_array($sql)){
                                              ...
                                              $hasil = mysqli_query($masuk,"SELECT * FROM tdescription, tgroup WHERE tdescription.groupId = '$id' AND tdescription.groupId = tgroup.groupId ORDER BY tgroup.groupId");
                                              $i = 1;
...
<nav class="navbar navbar-inverse navbar-absolut-bottom" role="navigation">
    <div class="container">
        ...
        <!-- Collect the nav links, forms, and other content for toggling -->
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
         <center><font color="white" size="1" >Created By</font></center>
     </div>
     <!-- /.navbar-collapse -->
 </div>
 <!-- /.container -->
    ...
    <form name="login" action="./adminweb/cek_login.php" method="POST" onSubmit="return validasi(this)" >
        <div class="modal-dialog">
            ...
            <div class="modal-footer">
                <center>Copyright &copy; <br> All rights reserved.</center>
