...
switch($_GET[act]){
			...
			<table id="tablekonten" class="table table-striped table-bordered table-responsive" style="">
				...
				<tbody>
					<?php 
					    ...
					    $tampil = mysqli_query($masuk,"SELECT * FROM tdescription order by groupId asc limit $posisi,$batas ");
					    $no = $posisi+1;
						...
						$jmldata = mysqli_num_rows(mysqli_query($masuk,"SELECT * FROM tdescription"));
					...
					<div class="col-sm-5">
						<div class="input-group">
							...
							<select name="groupId" id="" class="form-control">
								<?php 
								$sql = mysqli_query($masuk,"SELECT * FROM tgroup ORDER BY groupId");
  ...
  case "editdescription":
    $edit = mysqli_query($masuk,"SELECT * FROM tdescription WHERE descriptionId='$_GET[id]'");
